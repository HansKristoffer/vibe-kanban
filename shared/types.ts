...
export type InboxItem = { id: string, project_id: string, source: InboxSource, source_item_id: string, source_url: string | null, title: string, raw_payload_json: string | null, kind: InboxItemKind, status: InboxItemStatus, prd_markdown: string | null, task_id: string | null, linear_issue_id: string | null, linear_issue_url: string | null, action_token: string, slack_channel_id: string | null, slack_message_ts: string | null, slack_accepted_by_user_id: string | null, outbound_registered_at: Date, outbound_started_at: Date, outbound_pr_created_at: Date, outbound_pr_merged_at: Date, outbound_last_error: string | null, created_at: Date, updated_at: Date, };
