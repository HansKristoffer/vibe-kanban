...
export type UpsertProjectIntegrations = { webhook_token: string, linear_api_key: string | null, linear_team_id: string | null, linear_state_id_todo: string | null, linear_state_id_inprogress: string | null, linear_state_id_inreview: string | null, linear_state_id_done: string | null, linear_state_id_cancelled: string | null, linear_webhook_secret: string | null, intercom_access_token: string | null, intercom_webhook_secret: string | null, intercom_admin_id: string | null, modjo_api_key: string | null, modjo_webhook_secret: string | null, posthog_webhook_secret: string | null, sentry_webhook_secret: string | null, posthog_api_key: string | null, posthog_host: string | null, posthog_project_id: string | null, sentry_api_token: string | null, sentry_org_slug: string | null, sentry_project_slug: string | null, slack_bot_token: string | null, slack_signing_secret: string | null, slack_channel_id: string | null, };

export type ProjectEnvVar = { project_id: string, name: string, value: string, created_at: Date, updated_at: Date, };

export type InboxSource = "linear" | "intercom" | "modjo" | "manual" | "posthog" | "sentry" | "slack";

export type InboxItemKind = "bug" | "feature" | "other";

export type InboxItemStatus = "pending" | "accepted" | "declined" | "ignored";

export type InboxItem = { id: string, project_id: string, source: InboxSource, source_item_id: string, source_url: string | null, title: string, raw_payload_json: string | null, kind: InboxItemKind, status: InboxItemStatus, prd_markdown: string | null, task_id: string | null, linear_issue_id: string | null, linear_issue_url: string | null, action_token: string, slack_channel_id: string | null, slack_message_ts: string | null, slack_prd_thread_ts: string | null, slack_accepted_by_user_id: string | null, slack_created_by_user_id: string | null, outbound_registered_at: Date, outbound_started_at: Date, outbound_pr_created_at: Date, outbound_pr_merged_at: Date, outbound_last_error: string | null, created_at: Date, updated_at: Date, };
...
export type TaskWithAttemptStatus = { has_in_progress_attempt: boolean, last_attempt_failed: boolean, has_queued_attempt: boolean, executor: string, id: string, project_id: string, title: string, description: string | null, status: TaskStatus, parent_workspace_id: string | null, created_at: string, updated_at: string, };
...
export type CreateAndStartTaskRequest = { task: CreateTask, executor_profile_id: ExecutorProfileId, repos: Array<WorkspaceRepoInput>, ralph: RalphModeConfig | null, linked_issue: LinkedIssueInfo | null, };

export type WorkItemsResponse = { inbox_items: Array<InboxItem>, tasks: Array<TaskWithAttemptStatus>, };

export type ProjectIntegrationsResponse = { webhook_token: string, webhook_urls: WebhookUrls | null, linear_api_key: string | null, linear_team_id: string | null, linear_state_id_todo: string | null, linear_state_id_inprogress: string | null, linear_state_id_inreview: string | null, linear_state_id_done: string | null, linear_state_id_cancelled: string | null, linear_webhook_secret: string | null, intercom_access_token: string | null, intercom_webhook_secret: string | null, intercom_admin_id: string | null, modjo_api_key: string | null, modjo_webhook_secret: string | null, posthog_webhook_secret: string | null, sentry_webhook_secret: string | null, posthog_api_key: string | null, posthog_host: string | null, posthog_project_id: string | null, sentry_api_token: string | null, sentry_org_slug: string | null, sentry_project_slug: string | null, slack_bot_token: string | null, slack_signing_secret: string | null, slack_channel_id: string | null, linear_api_key_configured: boolean, linear_webhook_secret_configured: boolean, intercom_access_token_configured: boolean, intercom_webhook_secret_configured: boolean, modjo_api_key_configured: boolean, modjo_webhook_secret_configured: boolean, posthog_webhook_secret_configured: boolean, sentry_webhook_secret_configured: boolean, posthog_api_key_configured: boolean, sentry_api_token_configured: boolean, slack_bot_token_configured: boolean, slack_signing_secret_configured: boolean, };

export type UpdateProjectIntegrationsRequest = { linear_api_key: string | null, linear_team_id: string | null, linear_state_id_todo: string | null, linear_state_id_inprogress: string | null, linear_state_id_inreview: string | null, linear_state_id_done: string | null, linear_state_id_cancelled: string | null, linear_webhook_secret: string | null, intercom_access_token: string | null, intercom_webhook_secret: string | null, intercom_admin_id: string | null, modjo_api_key: string | null, modjo_webhook_secret: string | null, posthog_webhook_secret: string | null, sentry_webhook_secret: string | null, posthog_api_key: string | null, posthog_host: string | null, posthog_project_id: string | null, sentry_api_token: string | null, sentry_org_slug: string | null, sentry_project_slug: string | null, slack_bot_token: string | null, slack_signing_secret: string | null, slack_channel_id: string | null, clear_linear_api_key: boolean | null, clear_linear_webhook_secret: boolean | null, clear_intercom_access_token: boolean | null, clear_intercom_webhook_secret: boolean | null, clear_modjo_api_key: boolean | null, clear_modjo_webhook_secret: boolean | null, clear_posthog_webhook_secret: boolean | null, clear_sentry_webhook_secret: boolean | null, clear_posthog_api_key: boolean | null, clear_sentry_api_token: boolean | null, clear_slack_bot_token: boolean | null, clear_slack_signing_secret: boolean | null, };
...
export type PrError = { "type": "cli_not_installed", provider: ProviderKind, } | { "type": "cli_not_logged_in", provider: ProviderKind, } | { "type": "git_cli_not_logged_in" } | { "type": "git_cli_not_installed" } | { "type": "target_branch_not_found", branch: string, } | { "type": "unsupported_provider" } | { "type": "uncommitted_changes", branch: string, files: Array<string>, };
